...
using System.Text;
namespace WShop.MarsRover.Application.Common.Helpers
{
    public static class PaginationHelper
    {
        public static PagedResponse<IEnumerable<T>> CreatePagedReponse<T>(IEnumerable<T> pagedData, PagedConfig pagedConfig, IUriService uriService)
        {
